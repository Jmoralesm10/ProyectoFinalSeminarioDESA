...
const EditActivityPage = () => {
    ...
    <div className="edit-activity-container">
      ...
      <form onSubmit={handleSubmit} className="edit-activity-form">
        <div className="form-section">
          ...
          <div className="form-group">
            ...
            <input
              ...
              className={validationErrors.nombre_actividad ? 'error' : ''}
          ...
          <div className="form-group">
            ...
            <textarea
              ...
              onChange={handleInputChange}
              className={validationErrors.descripcion_actividad ? 'error' : ''}
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <select
                ...
                onChange={handleInputChange}
                className={validationErrors.tipo_actividad ? 'error' : ''}
              >
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={validationErrors.fecha_inicio_actividad ? 'error' : ''}
              />
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={validationErrors.fecha_fin_actividad ? 'error' : ''}
              />
          ...
          <div className="form-row">
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={validationErrors.lugar_actividad ? 'error' : ''}
            ...
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={validationErrors.cupo_maximo_actividad ? 'error' : ''}
                min="1"
                placeholder="30"
              />
        ...
        <div className="form-section">
          ...
          <div className="form-group">
            <label htmlFor="ponente_actividad">Ponente *</label>
            <input
              type="text"
              ...
              onChange={handleInputChange}
              className={validationErrors.ponente_actividad ? 'error' : ''}
        ...
        <div className="form-section">
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              <input
                ...
                max="100"
                placeholder="65"
                className={validationErrors.edad_maxima ? 'error' : ''}
              />
          ...
          <div className="form-row">
            <div className="form-group">
              <label htmlFor="costo_actividad">Costo de la Actividad</label>
              <input
                type="number"
                id="costo_actividad"
  ...
  return step === 'select' ? renderSelectionStep() : renderEditStep();
};
